...
julia --project -- ./main.jl -u http://mlflow.isiath.duckdns.org:8082 -t classification --predict_only --runid 8dbea59123ec469db3ee7b807b3ab6d9 -o /tmp/class.txt ./iris.csv
...
docker run -it --rm -v $(pwd):/data/ localhost/automlai:v2.0 -u http://mlflow.isiath.duckdns.org:8082 -t classification --predict_only --runid 8dbea59123ec469db3ee7b807b3ab6d9 /data/iris.csv
