...
### Prompt Panel
An assistant surface in the command deck that can answer operational questions by reading workflow and experiment context, while workflow state changes remain separate confirmed actions.
